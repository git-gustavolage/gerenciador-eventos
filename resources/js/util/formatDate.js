...
function normalizeFormat(format) {
    return format.replace(/HH:MM:ss/g, "HH:mm:ss");
}
...
export function formatDate(value, from = "YYYY-MM-DD", to = "DD/MM/YYYY") {
    ...
    const min = map.mm ? Number(map.mm) : 0;
    ...
    if (
        ...
        (map.mm && (Number.isNaN(min) || min < 0 || min > 59)) ||
    ...
    return to
        ...
        .replace("mm", map.mm ? String(min).padStart(2, "0") : "")
