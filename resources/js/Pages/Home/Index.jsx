...
export default function Index() {
    ...
    return (
        <GuestLayout title="Início">
            ...
            <div className="w-full p-16 py-32 bg-gradient-to-r from-emerald-600 to-emerald-800 text-white flex items-center justify-center flex-col gap-6 max-md:px-4">
