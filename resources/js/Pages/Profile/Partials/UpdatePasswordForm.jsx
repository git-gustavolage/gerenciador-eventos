...
export default function UpdatePasswordForm({ className = '' }) {
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-bold text-neutral-900">Atualizar Senha</h2>
                <p className="mt-1 text-sm text-neutral-500">
                    Garanta que sua conta esteja usando uma senha longa e aleatória para se manter seguro.
                </p>
            </header>
            ...
            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Transition
                        ...
                        leaveTo="opacity-0"
                    >
                        <p className="text-sm font-medium text-emerald-600">Senha atualizada.</p>
                    </Transition>
                </div>
            </form>
        </section>
