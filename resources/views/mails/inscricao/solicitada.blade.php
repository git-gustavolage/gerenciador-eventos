...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .header { background-color: #f59e0b; padding: 40px 32px; text-align: center; }
...
<body>
  <div class="email-container">
    ...
    <div class="body">
      ...
      <p>Sua solicitação de inscrição para o evento <strong>{{ $evento->titulo }}</strong> foi recebida com sucesso e enviada para a equipe de organização.</p>
      <p>Assim que o organizador aprovar sua participação, você receberá um novo e-mail confirmando sua vaga. A partir de então, você poderá se inscrever nas atividades da programação.</p>
  
      <div class="btn-container" style="text-align: center; margin: 32px 0;">
        <a href="{{ route('meus_eventos') }}" class="btn" style="display: inline-block; background-color: #f59e0b; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-weight: bold;">Acompanhar Inscrição</a>
      </div>
      ...
      <div class="link-box" style="background-color: #f9fafb; padding: 16px; border-radius: 6px; text-align: center; border: 1px dashed #d1d5db; word-break: break-all;">
        ...
        <p class="small" style="margin: 0;"><a href="{{ route('meus_eventos') }}" style="color: #f59e0b; font-size: 13px; text-decoration: underline;">{{ route('meus_eventos') }}</a></p>
      </div>
    </div>
    <div class="footer">
