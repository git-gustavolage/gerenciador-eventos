...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .header { background-color: #ea580c; padding: 40px 32px; text-align: center; }
    ...
    .btn { display: inline-block; background-color: #ea580c; color: #ffffff !important; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-weight: 600; font-size: 16px; transition: background-color 0.2s; }
    ...
    .small a { color: #ea580c; text-decoration: underline; }
...
<body style="background-color: #f4f7f6; margin: 0; padding: 20px 0; font-family: Arial, sans-serif;">
  <div class="email-container" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; border: 1px solid #e5e7eb;">
    ...
    <div class="header" style="background-color: #ea580c; padding: 40px 32px; text-align: center;">
      <span class="icon" style="font-size: 48px; display: block; margin-bottom: 12px;">🔄</span>
      <h1 style="color: #ffffff; font-size: 24px; margin: 0;">Alteração na Programação</h1>
    </div>
    ...
    <div class="body" style="padding: 40px 32px;">
      ...
      <p style="font-size: 16px; color: #4b5563; line-height: 1.6;">Informamos que a atividade <strong style="color: #111827;">{{ $atividade->titulo }}</strong>, que faz parte do evento <strong style="color: #111827;">{{ $evento->titulo }}</strong>, foi cancelada pela organização.</p>
      
      <p style="font-size: 16px; color: #4b5563; line-height: 1.6;">Sua inscrição nesta atividade específica foi cancelada. Suas demais inscrições no evento (caso existam) continuam ativas normalmente.</p>
      
      <p style="font-size: 16px; color: #4b5563; line-height: 1.6;">Acesse a plataforma E-IFRO para conferir outras atividades disponíveis na programação!</p>

      <div class="btn-container" style="text-align: center; margin: 32px 0;">
        <a href="{{ url('/') }}" class="btn" style="display: inline-block; background-color: #ea580c; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-weight: bold;">Acessar Plataforma E-IFRO</a>
      </div>
      ...
      <div class="link-box" style="background-color: #f9fafb; padding: 16px; border-radius: 6px; text-align: center; border: 1px dashed #d1d5db; word-break: break-all;">
        ...
        <p class="small" style="margin: 0;"><a href="{{ url('/') }}" style="color: #ea580c; font-size: 13px; text-decoration: underline;">{{ url('/') }}</a></p>
      </div>
    </div>
